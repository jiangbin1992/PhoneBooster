package com.gm.phonecleaner.rec;
...
import com.gm.phonecleaner.appdata.BatteryTask;
        ...
        if (intent.getAction().equals(AlarmUtils.ACTION_AUTOSTART_ALARM)) {
            ...
            if (extras != null) {
                ...
                if (extras.getBoolean(AlarmUtils.ALARM_PHONE_BOOOST)) {
                    ...
                    new BatteryTask(context, BatteryManager.EXTRA_TEMPERATURE, pin -> {
                    ...
                    new BatteryTask(context, BatteryManager.EXTRA_LEVEL, pin -> {
