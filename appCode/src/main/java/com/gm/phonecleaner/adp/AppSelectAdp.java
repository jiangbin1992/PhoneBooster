...
public class AppSelectAdp extends RecyclerView.Adapter<AppSelectAdp.ViewHolder> {
    ...
    public AppSelectAdp(Context mContext, TYPE_SELECT mTypeSelect, List<TaskInfo> arrList) {
    ...
    @NonNull
    @Override
    public AppSelectAdp.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(mContext).inflate(R.layout.item_app_select, parent, false);
        return new ViewHolder(mView);
    }

    @Override
    public void onBindViewHolder(@NonNull AppSelectAdp.ViewHolder holder, int position) {
