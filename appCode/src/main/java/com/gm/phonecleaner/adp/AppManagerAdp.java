...
public class AppManagerAdp extends AnimatedExpandableListView.AnimatedExpandableListAdapter {
    private LayoutInflater inflater;
    private PackageManager mPackageManager;
    private List<GroupItemAppManager> items;
    private OnClickItemListener mOnClickItemListener;

    public AppManagerAdp(Context context, List<GroupItemAppManager> items,
