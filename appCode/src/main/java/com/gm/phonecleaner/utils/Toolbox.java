...
public class Toolbox {
    ...
    public static void creatShorCutGameBoost(Context mContext) {
        ...
        if (shortcutManager.isRequestPinShortcutSupported()) {
            ...
            shortcutManager.requestPinShortcut(build, PendingIntent.getBroadcast(mContext,
                    0, shortcutManager.createShortcutResultIntent(build), flags).getIntentSender());
        }
    }
    ...
    public static void creatShorCutNormal(Context mContext) {
        ...
        if (shortcutManager.isRequestPinShortcutSupported()) {
            ...
            shortcutManager.requestPinShortcut(build, PendingIntent.getBroadcast(mContext, 0, shortcutManager.createShortcutResultIntent(build), flags).getIntentSender());
        }
    }
