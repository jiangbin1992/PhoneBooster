...
public class Config {
    ...
    public static final FUNCTION[] LST_HOME_HORIZONTAL = new FUNCTION[]{
            FUNCTION.JUNK_FILES, FUNCTION.CPU_COOLER, FUNCTION.PHONE_BOOST, FUNCTION.ANTIVIRUS, FUNCTION.POWER_SAVING, FUNCTION.GAME_BOOSTER_MAIN, FUNCTION.DEEP_CLEAN, FUNCTION.APP_UNINSTALL, FUNCTION.APP_LOCK, FUNCTION.SMART_CHARGE
    };
    ...
    public static final FUNCTION[] LST_TOOL_SECURITY = new FUNCTION[]{
            FUNCTION.NOTIFICATION_MANAGER, FUNCTION.APP_LOCK, FUNCTION.SMART_CHARGE
    };
