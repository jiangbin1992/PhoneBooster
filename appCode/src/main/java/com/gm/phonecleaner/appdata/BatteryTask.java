...
public class BatteryTask extends AsyncTask<Void, Integer, Integer> {

    private Context mContext;
    private OnTaskBatteryListener mOnTaskBatteryListener;
    private String typeGetData;

    public BatteryTask(Context context, String typeGetData, OnTaskBatteryListener onTaskBatteryListener) {
