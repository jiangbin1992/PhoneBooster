...
import com.gm.phonecleaner.app_db.DataHelper;
import com.gm.phonecleaner.app_db.FSEnvi;
...
public class ScanAntivirusTask extends AsyncTask<Void, String, List<TaskInfo>> {
    ...
    public ScanAntivirusTask(Context mContext, long timeSleep, OnTaskListListener mOnTaskListListener) {
        this.mOnTaskListListener = mOnTaskListListener;
        this.mContext = mContext;
        this.timeSleep = timeSleep;
    }

    public ScanAntivirusTask(Context mContext, String pkgName, long timeSleep, OnTaskListListener mOnTaskListListener) {
        this.mOnTaskListListener = mOnTaskListListener;
        this.mContext = mContext;
        this.timeSleep = timeSleep;
