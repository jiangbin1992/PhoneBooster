...
import com.gm.phonecleaner.password.utils.NotificationUtil;
...
public class LockService extends IntentService {
    ...
    private void passwordLock(String packageName) {
        try {
            PhoneCleanerApp.getInstance().clearAllActivity();
        } catch (Exception e) {
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        if (lockState) {
            ...
            PendingIntent restartPendingIntent = PendingIntent.getService(getApplicationContext(), 1495, restartServiceTask, flags);
