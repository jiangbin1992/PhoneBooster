...
import com.gm.phonecleaner.password.adp.SelectTimeAdp;
...
public class SelectLockTimeDialog extends BaseDialog {
    ...
    private SelectTimeAdp mSelectTimeAdp;
    ...
    protected void init() {
        ...
        mSelectTimeAdp = new SelectTimeAdp(mTimeList, context);
        mRecyclerView.setAdapter(mSelectTimeAdp);
        mSelectTimeAdp.setTitle(title);
        mSelectTimeAdp.setListener(new SelectTimeAdp.OnItemClickListener() {
            @Override
