...
import com.gm.phonecleaner.ui.antivirus.fragment.ListAppDangerousFragment;
import com.gm.phonecleaner.ui.antivirus.fragment.ListAppVirusFragment;
import com.gm.phonecleaner.utils.Config;
import com.gm.phonecleaner.widget.AntivirusScanView;
...
public class AntivirusActivity extends BaseActivity {
    ...
    TextView tvToolbar;
    @BindView(R2.id.antivirusScanView)
    AntivirusScanView mAntivirusScanView;
    @BindView(R2.id.tv_number_virus)
    TextView tvVirusNumber;
    @BindView(R2.id.tv_number_dangerous)
    TextView tvDangerousNumber;
    @BindView(R2.id.ll_background)
    View llBackground;
    @BindView(R2.id.tv_total_issues)
    ...
    private void initData() {
        ...
        isCanback = false;
        new ScanAntivirusTask(this, 200, new ScanAntivirusTask.OnTaskListListener() {
            @Override
    ...
    @OnClick({R2.id.tv_check_virus, R2.id.tv_check_dangerous, R2.id.tv_skip_dangerous, R2.id.tv_resolve_all, R2.id.id_menu_toolbar})
