...
import com.gm.phonecleaner.utils.BaseApp;
...
public class NotificationCleanGuildActivity extends BaseActivity {
    ...
    View mIvIcon3;
    @BindView(R2.id.iv_item_1)
    View mIvItem1;
    @BindView(R2.id.iv_item_2)
    View mIvItem2;
    @BindView(R2.id.iv_item_3)
    View mIvItem3;
    @BindView(R2.id.iv_start_0_0)
    View mIvStart00;
    @BindView(R2.id.iv_start_0_1)
    View mIvStart01;
    @BindView(R2.id.iv_start_0_2)
    View mIvStart02;
    @BindView(R2.id.iv_start_1_0)
    View mIvStart10;
    @BindView(R2.id.iv_start_1_1)
    View mIvStart11;
    @BindView(R2.id.iv_start_1_2)
    View mIvStart12;
    @BindView(R2.id.iv_start_1_3)
    View mIvStart13;
    @BindView(R2.id.layout_icon)
    View mLayoutIcon;
    @BindView(R2.id.layout_item_0)
    View mLayoutItem0;
