package com.gm.phonecleaner.ui.phoneboost;
...
import com.gm.phonecleaner.appdata.OpenForceStopTask;
import com.gm.phonecleaner.dialog.DialogSelection;
...
import com.gm.phonecleaner.widget.CpuScanView;
import com.gm.phonecleaner.widget.PowerScanView;
import com.gm.phonecleaner.widget.RocketScanView;
...
public class PhoneBoostActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        rcvAppRunning.setAdapter(mAppSelectAdp);
        getListAppRunning();
    }
    ...
    private void runkillApp() {
        anmationRunning = true;
        new AppKillProg(this, lstApp).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        playAnimationDone();
    }
    ...
    @OnClick({R2.id.tv_boost, R2.id.cb_select_all, R2.id.id_menu_toolbar})
    ...
    public void startDeepClean() {
        ...
        new OpenForceStopTask(this, lstSelect).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
