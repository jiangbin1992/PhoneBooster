...
public class PowerScanView extends RelativeLayout {
    ...
    TextView tvContent;
    @BindView(R2.id.layout_anim_container)
    RelativeLayout layoutAnimContainer;
    @BindView(R2.id.tv_content_done)
    ...
    public void startProgress(List<TaskInfo> lstApp, long timeCleanOneApp, AnimationListener mAnimationListener) {
        ...
        Toolbox.animationTransColor(getResources().getColor(R.color.color_ffa800), getResources().getColor(R.color.colorPrimary), lstApp.size() * 300, llMain);
