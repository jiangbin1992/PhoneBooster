...
public class RocketScanView extends RelativeLayout {
    ...
    public void playAnimationDone(AnimationListener mAnimationListener) {
        ...
        Toolbox.animationTransColor(getResources().getColor(R.color.color_ffa800), getResources().getColor(R.color.colorPrimary), 4000, llMain);
